...
while {alive _al_gravity_emiter} do {
	// gravity say3d "vum";
	[_al_gravity_emiter,"vum"] remoteExec ["say3D",0];
	sleep 11;
};
};
...
_ref setParticleParams [["\A3\data_f\ParticleEffects\Universal\Refract.p3d", 1, 0, 1], "", "Billboard", 1, 60, [0, 0, 0], [0, 0, 0], 5, 10, 7.9, 0.000001, [20, 20, 20], [[1, 1, 1, 1], [1, 1, 1, 0.5], [1, 1, 1, 1]], [0.08], 1, 0, "", "", _al_gravity];
